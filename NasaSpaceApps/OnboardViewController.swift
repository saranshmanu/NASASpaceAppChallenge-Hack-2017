...
extension ViewController: PaperOnboardingDataSource {
    ...
    func onboardingItemAtIndex(_ index: Int) -> OnboardingItemInfo {
        ...
        return [
            ...
            (UIImage.Asset.Banks.rawValue, "VIT University", "April 29-30", UIImage.Asset.Wallet.rawValue, UIColor.init(red: 0/255, green: 157/255, blue: 214/255, alpha: 1.0), UIColor.white, UIColor.white, titleFont,descriptionFont),
